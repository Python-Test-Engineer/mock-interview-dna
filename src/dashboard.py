...
def kpi_card(
    title: str, value: str, icon: str = "bi-bar-chart-fill", color: str = "primary"
):
    return ui.div(
        ui.div(
...
def _overview_ui():
    ...
    kpis = ui.row(
        ui.column(
            3,
            kpi_card("Total Appointments", total, "bi-calendar-check-fill", "primary"),
        ),
        ui.column(3, kpi_card("Unique Patients", patients, "bi-people-fill", "info")),
        ui.column(
            3,
            kpi_card(
                "Overall No-Show Rate", f"{noshow}%", "bi-x-circle-fill", "warning"
            ),
        ),
        ui.column(
            3, kpi_card("Dirty Rows Removed", dirty_n, "bi-trash-fill", "danger")
        ),
    )
...
def _gallery_ui():
    ...
    return ui.div(
        ...
        ui.p(
            f"{len(png_files)} charts generated by the analysis pipeline.",
...
def _statistics_ui():
    ...
    return ui.div(
        ...
        ui.row(
            ui.column(
                6, ui.h5("No-Show Rate by Category"), output_widget("noshow_chart")
            ),
            ui.column(
                6, ui.h5("No-Show Rate by Lead Days"), output_widget("lead_chart")
            ),
        ),
